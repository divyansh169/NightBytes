...
//    String[] CoochBehar={"CoochBehar"};
    ...
    Button companynameregisterbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companynameregisterbutton = (Button) findViewById(R.id.companynameregisterbutton);
        Suburban = (Spinner) findViewById(R.id.Suburban);

//        spinnerList = new ArrayList<>();
//        adapter = new ArrayAdapter<String> (ChefRegisteration.this , android.R.layout.simple_spinner_dropdown_item, spinnerList);
...
//        DatabaseReference  dbref = FirebaseDatabase.getInstance().getReference("Spinner Data").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
...
//        });
        ...
        companynameregisterbutton.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            ...
            Toast.makeText(ChefRegisteration.this, "Saved", Toast.LENGTH_SHORT).show();
        }
        });
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(ChefRegisteration.this, Chefsendotp.class);
