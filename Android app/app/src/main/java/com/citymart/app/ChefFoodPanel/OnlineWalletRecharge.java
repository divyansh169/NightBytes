...
import com.citymart.app.CustomerFoodPanel.CustomerPaymentOrders;
...
public class OnlineWalletRecharge extends AppCompatActivity implements PaymentResultListener {
    ...
    public String totwalstr;
//    public static int amtrs = 1;
    Dialog dialog;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_online_wallet_recharge);
...
//        axudatabaseReference.addValueEventListener(new ValueEventListener() {
//            @Override
...
//                                    }
                                    ...
                                    Payond.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Toast.makeText(OnlineWalletRecharge.this, "Please wait for payment page to open", Toast.LENGTH_SHORT).show();
...
//                                                                            if (dataSnapshot.exists()) {
                                                    ...
                                                    String url = "https://us-central1-fooddelivery-d9c7a.cloudfunctions.net/createRazorpayOrder?kid=" + "rzp_live_cZZPCw7KRIyrHE" + "&ksec=" + "vIQ1yUknoXYAR5XnVOA9dEdX" + "&amt=" + (1000 * 100);
...
//            }
//        });
        DatabaseReference axudatabaseRfdeference = FirebaseDatabase.getInstance().getReference("ChefWallet").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
        axudatabaseRfdeference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
...
//                    int totwal = ;
                    axudatabaseRfdeference.child("wal").setValue(currval + 1000);
...
//
//                    Type31 type31= new Type31(0);
//                    guoki.setValue(type31);

                }
                else{
//                    DatabaseReference asdf = FirebaseDatabase.getInstance().getReference("ChefWallet").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
//                    Type70 type70 = new Type70(amtrs);
                    axudatabaseRfdeference.child("wal").setValue(1000);

//                    FirebaseDatabase.getInstance().getReference("ChefStopped").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("stopped").setValue(0);
//
//                    Type31 type31= new Type31(0);
//                    guokiz.setValue(type31);
//                    Toast.makeText(OnlineWalletRecharge.this, "ID inserted",Toast.LENGTH_SHORT).show();
                }
            }
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlineWalletRecharge.this);
        builder.setMessage("Wallet Recharged successfully!");
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.dismiss();
                Intent b = new Intent(OnlineWalletRecharge.this, ChefFoodPanel_BottomNavigation.class);
