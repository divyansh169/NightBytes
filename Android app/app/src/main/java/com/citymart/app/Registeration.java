 ...
 */
    ...
    Button Signin, Email, Phone, getcurradd;
    FirebaseAuth FAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            getcurradd = (Button) findViewById(R.id.getcurradd);
...
//            getCurrentLocation();
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    adapter = new ArrayAdapter<String> (Registeration.this , android.R.layout.simple_spinner_dropdown_item, spinnerList);
                                                    ...
                                                    FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                builder.setMessage("Registered Successfully, (Now Verify Phone Number to get Notifications && Please Check Your Mail and Verify By Clicking on The Link. If not able to find, Check Your Spam Folder. After Verifying, You Can Sign-In With Your Email ID)");
...
////                                                                                PhoneAuthCredential credentialy = PhoneAuthProvider.getCredential(verificationId, code);
//                                                                                signIn(credential);
//                                                                            }
//
//                                                                            @Override
...
//                                                                                Registeration.this.verificationId = verificationId;
//                                                                                resendToken = token;
//                                                                            }
//
//                                                                            @Override
...
//                                                                                callbacks);
                                                                        ...
                                                                        //.....................................
                                                                        Intent b = new Intent(Registeration.this, sendotp.class);
...
//                finish();//removed finish();
    ...
    private void getCurrentLocation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ActivityCompat.checkSelfPermission(Registeration.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {

                if (isGPSEnabled()) {

                    LocationServices.getFusedLocationProviderClient(Registeration.this)
...
//                                        localadd.setText;
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                ...
                try {
                    ...
                    Toast.makeText(Registeration.this, "GPS is already tured on", Toast.LENGTH_SHORT).show();
                    ...
                    switch (e.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvableApiException.startResolutionForResult(Registeration.this, 2);
    ...
    private void signIn(PhoneAuthCredential credential) {
        ...
        existingUser.linkWithCredential(credential)
                .addOnCompleteListener(Registeration.this, task -> {
                    if (task.isSuccessful()) {
                        // Linked successfully
...
//    String emailpattern2 = "[a-zA-Z0-9._-]+@lnmiit.ac.in";
