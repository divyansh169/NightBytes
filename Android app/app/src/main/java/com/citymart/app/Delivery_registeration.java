    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                adapter = new ArrayAdapter<String> (Delivery_registeration.this , android.R.layout.simple_spinner_dropdown_item, spinnerList);
...
//                                String useridd = (FirebaseAuth.getInstance().getCurrentUser().getUid()) + suburban;
...
//                                                DatabaseReference dataal = FirebaseDatabase.getInstance().getReference().child("deliveryshipper").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
//                                                Type9 type9 = new Type9(suburban);
//                                                dataal.setValue(type9);



//                                        firebaseDatabase.getInstance().getReference("DeliveryPerson").child(deliveryId).setValue(hashMappp).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        firebaseDatabase.getInstance().getReference("DeliveryPerson").child(useridd).setValue(hashMappp).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(Delivery_registeration.this, Delivery_SendOtp.class);
