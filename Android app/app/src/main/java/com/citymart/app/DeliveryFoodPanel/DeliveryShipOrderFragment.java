...
public class DeliveryShipOrderFragment extends Fragment {
    ...
    private DeliveryShipOrderFragmentAdapter adapterlp;
    private DatabaseReference databaseReference;
    public static String dulid = FirebaseAuth.getInstance().getCurrentUser().getUid() ;
...
//        DatabaseReference datagbaseReference = FirebaseDatabase.getInstance().getReference("deliveryshipper").child((FirebaseAuth.getInstance().getCurrentUser().getUid())).child("suburbanus");
//        datagbaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
//            @Override
//            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
//                Type9 type9 = dataSnapshot.getValue(Type9.class);
//                suburbin = type9.getsuburbanus();

//                dulid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    data.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            adapterlp = new DeliveryShipOrderFragmentAdapter(getContext(), deliveryShipFinalOrders1List);
